# 🥦 냉부해 (NaengBuHae) – AI 기반 개인화 냉장고 관리 및 레시피 추천 서비스

> **1인 가구의 식재료 소비 효율화를 위한 모바일 퍼스트 재고 관리 및 하이브리드 레시피 추천 웹 앱 MVP**
> 본 프로젝트는 기획자가 제품 정의(PRD)부터 데이터 구조 설계(ERD), 알고리즘 로직 설계, 프론트엔드 빌드 및 백엔드 API 연동까지 전 과정을 주도한 '행동형 기획(Vibe Coding)'의 결과물입니다.
